                ...
                <div className='w-[300px] sm:w-[350px] lg:w-[370px] relative max-w-[100%] sm:min-h-[480px] min-h-[380px] bg-white shadow-2xl overflow-hidden'>
                    <div className="sm:mt-20 mt-10 h-[100%]">
                        <form onSubmit={handleSubmit} className='flex-col flex align-middle h-[100%] px-[40px] content-center'>
                            ...
                            <button className='sm:self-center bg-black text-white rounded-xl hover:bg-black/80 text-[12px] w-[220px]  py-4 px-10 font-bold uppercase cursor-pointer mt-5' type="submit">Login</button>
                            <p className='sm:mt-20 mt-5 w-[100%] text-center'>Don't have an account? <a href="/register" className='hover:underline hover:text-black/80 text-black'>Register</a></p>
                        </form>
                    </div>
                </div>
            </div>
